...
import { Camera, Upload, X, Check, FileText, Calendar, Clock } from "lucide-react";

const RentForm = ({ open, onOpenChange, product }) => {
    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent className="w-[95%] sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete el formulario para solicitar la renta de este producto.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            <h3 className="text-md font-semibold">Datos personales</h3>
          ...
          {/* Fechas de renta */}
          <div className="space-y-4">
            <h3 className="text-md font-semibold">Período de renta</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-md font-semibold">Identificación oficial</h3>
