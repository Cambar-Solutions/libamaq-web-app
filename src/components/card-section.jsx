    ...
    <section className="py-10 px-6 w-3/4 m-auto ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 ">
        {items.map((item, index) => (
          <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:scale-105 ease-in transition-all 2s">
            <div className="p-4">
            ...
            <div className="p-4">
              ...
              <Link to={`/detalle/${item.title}`}>
                <Button className="mt-4 w-full bg-black text-white hover:bg-gray-700">Ver detalles</Button>
              </Link>
            </div>
          </div>
        ))}
