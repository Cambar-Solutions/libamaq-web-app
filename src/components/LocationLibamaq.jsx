...
const LocationLibamaq = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex w-full mx-auto space-y-6 p-4 pt-32 justify-around">
        {locations.map((loc) => (
          <div key={loc.id} className="bg-white rounded-2xl shadow-sm w-[40%] h-[30em] hover:shadow-lg hover:scale-102 transition-all duration-500">
            {/* Header */}
            <div className="bg-gray-200 text-center text-gray-700 text-2xl font-medium py-2 rounded-t-2xl">
              {loc.cityState}
            </div>
            ...
            <div className="px-4 py-3 text-gray-800 h-[60%]">
              <div className="mb-5 text-base text-gray-500">
                ...
                <p className="text-blue-600">{loc.email}</p>
              </div>
              ...
              {/* <div className="bg-white px-4 py-3 border-t flex justify-end rounded-b-2xl">
                <button
                  onClick={() => window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(loc.name)}`, "_blank")}
                  className="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-medium px-3 py-1 rounded"
                >
